      ...
      <Layout>
        <div>
          ...
          {/*
            ...
            */}
          <Link to="/tags">
            <div className="div-tag marginbottom">Ve todos los tags</div>
          </Link>

          <div style={{ padding: "10px" }}>
            <p>
              En esta página, podrás encontrar todos los temas que tenemos
              relacionados con la palabra clave {tag}. Todos nuestros resumenes
              de examen y bancos de preguntas para examen son ideales para
              estudiar antes de tu examen. Ya sea para prepararte para la
              universidad o en preparatoria. Si la etiqueta {tag} no es lo que
              estás buscando, te recomendamos que busques dentro de nuestras
              <Link to="/categorias"> categorías</Link> y busques dentro de
              nuestro contenido algo que sea relevante para ti. También te
              invitamos a usar nuestro <Link to="/search">buscador </Link>
              donde podrás acceder de una manera mucho más rápida a nuestro
              contenido.
            </p>
          </div>
