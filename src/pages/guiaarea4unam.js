...
import guia from "../images/guias/GuiaArea4.pdf"
...
export default function Home() {
  ...
  return (
    ...
    <Layout>
    <div style={{margin: "2%"}}>
        <Heading color="dark" alignment="center">Guías para Area 4 UNAM</Heading>
        <h2>En esta página puedes encontrar la guía más reciente publicada por la UNAM. Da click en el botón para descargarla</h2>
