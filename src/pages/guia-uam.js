  ...
  return (
    <React.Fragment>
      <Helmet title="Temas resumidos para antes del examen | Guias UNAM 2021">
        <meta
          name="description"
          content="Preparate para tu examen con las guias actualizadas 2021 para el IPN"
        />
      </Helmet>
      <Layout>
        <div style={{ margin: "2%" }}>
          ...
          <h2>
            En esta página puedes encontrar las guías más recientes de la UAM.
            Da click en el botón para descargarlas
          </h2>
          <p>
            Arquitectura, Diseño, Diseño de la Comunicación Gráfica, Diseño
            Industrial, Planeación Territorial
          </p>
          <a
            target="_blank"
